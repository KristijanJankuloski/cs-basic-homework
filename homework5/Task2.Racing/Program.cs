...
Driver[] drivers = new Driver[] { new Driver("Bob", 0.7), new Driver("Greg", 0.9), new Driver("Jill", 0.6), new Driver("Anne", 0.8) };
Car[] cars = new Car[] { new Car("Hyundai", 218), new Car("Mazda", 227), new Car("Ferrari", 264), new Car("Porsche", 243) };
